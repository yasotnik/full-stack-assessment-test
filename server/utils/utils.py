        ...
        acc.append(
            {
                "id": door.id,
                "name": door.name,
                "installation_time": parse_timestamp_with_timezone(
                    door.installation_time
                ),
                "sensor_uuid": door.sensor_uuid,
                "last_opening": timestamp_to_datetime(
                    doors_last_open[door.sensor_uuid]
                ),
        ...
        users.append(
            {
                ...
                "access_granted_at": parse_timestamp_with_timezone(
                    user_door.creation_time
                ),
            }
        )
